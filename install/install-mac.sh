...
if command -v conda &> /dev/null; then
    ...
    MINICONDA_URL="https://repo.anaconda.com/miniconda/Miniconda3-py312_24.11.1-0-MacOSX-arm64.sh"
    DESTINATION_PATH="$USER_HOME/Downloads/Miniconda3-latest-MacOSX-arm64.sh"
...
if [ "$ENABLE_CHINA_CONFIG" = true ]; then
    ICON_URL="https://cracknuts.cn/img/icon.icns"
else
    ICON_URL="https://cracknuts.io/img/icon.icns"
fi
ICON_DIR_PATH="$USER_HOME/.cracknuts"
mkdir -p "$ICON_DIR_PATH"
ICON_PATH="$ICON_DIR_PATH/icon.icns"
